...
public class LineChartActivity2 extends FragmentActivity {
...
//            }
        ...
        private void generateValues() {
            ...
            randomNumbersTab[0][0]=-10;
            randomNumbersTab[0][1]=-10;
            randomNumbersTab[0][1]=-50;
        }
        ...
        private void generateData() {
            ...
            for (int i = 0; i < numberOfLines; ++i) {//线的个数
            	List<PointValue> values = new ArrayList<PointValue>();

                values.add(new PointValue(1.0f, 33.0155f));
                values.add(new PointValue(2.0f, 30.5471f));
                values.add(new PointValue(11.0f,-14.8485f));
