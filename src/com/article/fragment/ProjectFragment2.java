 ...
 * @Description:   项目
 */
public class ProjectFragment2 extends BaseFragment implements LocationSource, AMapLocationListener{
	...
	public void initView(Bundle bundle, View view) {
		...
		drawRoadLine = new DrawRoadLine(aMap, context, 3000);
